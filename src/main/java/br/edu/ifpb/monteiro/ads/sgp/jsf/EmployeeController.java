...
import br.edu.ifpb.monteiro.ads.sgp.dao.EmployeeFacade;
...
public class EmployeeController implements Serializable {
    ...
    @EJB
    private br.edu.ifpb.monteiro.ads.sgp.dao.EmployeeFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/resources/Bundle").getString("EmployeeCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/resources/Bundle").getString("EmployeeUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/resources/Bundle").getString("EmployeeDeleted"));
        if (!JsfUtil.isValidationFailed()) {
